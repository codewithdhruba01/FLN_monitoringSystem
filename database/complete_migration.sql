-- FLN Monitoring System - Complete Database Migration
-- This file contains the complete schema with all tables, constraints, and sample data
-- Run this file once to set up your entire database from scratch
...
-- Create schools table (linked to clusters)
...
-- Create teachers table (linked to both cluster and school)
...
-- Create students table (linked to both cluster and school)
...
-- Create monitoring_reports table (linked to cluster, school, and teacher)
...
-- Create monitoring_materials table (linked to report, cluster, and school)
...
-- Create monitoring_subjects table (linked to report, cluster, and school)
...
-- Create student_performance table (linked to report, cluster, school, and student)
...
-- Create student_attendance table (linked to report, cluster, school, and student)
...
-- - 2 Clusters
-- - 21 Schools from the workbook teacher sheets
-- - 21 Teachers mapped to those schools
-- - All tables properly linked with cluster_id and school_id
